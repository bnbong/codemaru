...
$$\operatorname{logScore}(v,\,s) \;=\; \min\!\left(100,\; \frac{\ln(1+v)}{\ln(1+s)}\times 100\right)$$
...
$$\operatorname{logScore}(386,\,2000)=\frac{\ln(387)}{\ln(2001)}\times 100=\frac{5.96}{7.60}\times 100\approx \mathbf{78.4}$$
...
$$\operatorname{linScore}(v,\,m) \;=\; \min\!\left(100,\; \frac{v}{m}\times 100\right)$$
...
$$\text{ProblemSolving}=\operatorname{logScore}(\underbrace{229}_{\text{BOJ}}+\underbrace{2}_{\text{LeetCode}},\;2500)=\operatorname{logScore}(231,\,2500)\approx\mathbf{69.6}$$
...
**Breadth bonus** — language count, normalized: $\operatorname{logScore}(12,\,12)=100$.
...
$$f_{\text{judge}}=\text{trust}\times\frac{\operatorname{logScore}\big(\max(0,\ \text{solved}-10),\ s\big)}{100}$$
...
- solved.ac factor: trust $1.0$, $\operatorname{logScore}(229-10,\,2200)/100 \Rightarrow f_{\text{solvedac}} = 0.701$
...
$$\text{ProblemSolving}=\operatorname{logScore}(\underbrace{229}_{\text{백준}}+\underbrace{2}_{\text{LeetCode}},\;2500)=\operatorname{logScore}(231,\,2500)\approx\mathbf{69.6}$$
...
**다양성 보너스** — 언어 개수 정규화: $\operatorname{logScore}(12,\,12)=100$.
